...
export default function AdminProdutos() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      setMensagem({
        tipo: 'erro',
        texto: err instanceof Error ? err.message : 'Erro ao salvar produto.',
      });
    } finally {
      setSaving(false);
    }
  ...
  async function handleExcluir(id: number) {
    ...
    try {
      ...
      setMensagem({
        tipo: 'erro',
        texto: err instanceof Error ? err.message : 'Erro ao remover produto.',
      });
    }
  }
  ...
  return (
    <AdminLayout
      title="Produtos"
      subtitle="Cadastre e edite os óculos exibidos no site"
      showBack
    >
      {mensagem && (
              ...
              {ofertas.map((item) => (
                ...
                >
                  ...
                  <div className="admin-oferta-actions">
                    <button type="button" className="btn btn-edit" onClick={() => handleEditar(item)}>
                      Editar
                    </button>
                    <button
                      type="button"
